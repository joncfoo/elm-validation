...
var _joncfoo$applicative_validation$Validation$transform = F3(
	function (fnE, fnA, v) {
		var _p0 = v;
		if (_p0.ctor === 'Invalid') {
			return fnE(_p0._0);
...
var _joncfoo$applicative_validation$Validation$Valid = function (a) {
	return {ctor: 'Valid', _0: a};
};
var _joncfoo$applicative_validation$Validation$valid = function (a) {
	return _joncfoo$applicative_validation$Validation$Valid(a);
};
var _joncfoo$applicative_validation$Validation$Invalid = function (a) {
	return {ctor: 'Invalid', _0: a};
};
var _joncfoo$applicative_validation$Validation$invalid = function (e) {
	return _joncfoo$applicative_validation$Validation$Invalid(
		_hrldcpr$elm_cons$Cons$singleton(e));
};
var _joncfoo$applicative_validation$Validation$map = F2(
	function (fn, v) {
		var _p1 = v;
		if (_p1.ctor === 'Invalid') {
			return _joncfoo$applicative_validation$Validation$Invalid(_p1._0);
		} else {
			return _joncfoo$applicative_validation$Validation$Valid(
				fn(_p1._0));
		}
	});
...
var _joncfoo$applicative_validation$Validation$bimap = F3(
	function (fnE, fnA, v) {
		...
		if (_p2.ctor === 'Invalid') {
			return _joncfoo$applicative_validation$Validation$Invalid(
				A2(_hrldcpr$elm_cons$Cons$map, fnE, _p2._0));
		} else {
			return _joncfoo$applicative_validation$Validation$Valid(
				fnA(_p2._0));
		}
...
var _joncfoo$applicative_validation$Validation$apply = F2(
	function (vFn, v) {
		...
		if (_p3.ctor === 'Invalid') {
			...
			if (_p4.ctor === 'Invalid') {
				return _joncfoo$applicative_validation$Validation$Invalid(
					A2(_hrldcpr$elm_cons$Cons$append, _p5, _p4._0));
			} else {
				return _joncfoo$applicative_validation$Validation$Invalid(_p5);
			}
		} else {
...
var _joncfoo$applicative_validation$Validation_Validator$inList = F3(
	function (err, list, value) {
		return A2(_elm_lang$core$List$member, value, list) ? _joncfoo$applicative_validation$Validation$valid(value) : _joncfoo$applicative_validation$Validation$invalid(err);
	});
var _joncfoo$applicative_validation$Validation_Validator$notInList = F3(
	function (err, list, value) {
		return A2(_elm_lang$core$List$member, value, list) ? _joncfoo$applicative_validation$Validation$invalid(err) : _joncfoo$applicative_validation$Validation$valid(value);
	});
var _joncfoo$applicative_validation$Validation_Validator$isEmail = F2(
	function (err, s) {
		var emailRE = _elm_lang$core$Regex$caseInsensitive(
			_elm_lang$core$Regex$regex('^.+@.+$'));
		return A2(_elm_lang$core$Regex$contains, emailRE, s) ? _joncfoo$applicative_validation$Validation$valid(s) : _joncfoo$applicative_validation$Validation$invalid(err);
	});
var _joncfoo$applicative_validation$Validation_Validator$isNumber = F2(
	function (err, s) {
		var _p0 = _elm_lang$core$String$toInt(s);
		if (_p0.ctor === 'Err') {
			return _joncfoo$applicative_validation$Validation$invalid(err);
		} else {
			return _joncfoo$applicative_validation$Validation$valid(s);
		}
	});
var _joncfoo$applicative_validation$Validation_Validator$maxLength = F3(
	function (n, mkErr, s) {
		return (_elm_lang$core$Native_Utils.cmp(
			_elm_lang$core$String$length(s),
			n) > 0) ? _joncfoo$applicative_validation$Validation$invalid(
			mkErr(n)) : _joncfoo$applicative_validation$Validation$valid(s);
	});
var _joncfoo$applicative_validation$Validation_Validator$minLength = F3(
	function (n, mkErr, s) {
		return (_elm_lang$core$Native_Utils.cmp(
			_elm_lang$core$String$length(s),
			n) < 0) ? _joncfoo$applicative_validation$Validation$invalid(
...
var _joncfoo$applicative_validation$Validation_Validator$notBlank = F2(
	function (err, s) {
...
var _joncfoo$applicative_validation$Main$renderError = function (error) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('form_validator-error'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
...
var _joncfoo$applicative_validation$Main$renderField = F3(
	function (name, errors, inputHtml) {
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('field-content'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('page-label'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Validation Demo'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
											...
											},
											{
												...
												_1: {
													...
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$value('user'),
															_1: {ctor: '[]'}
														},
														{
															ctor: '::',
													...
													_1: {
														...
														_0: A2(
															...
															{
																ctor: '::',
																_0: _elm_lang$html$Html_Attributes$value('admin'),
																_1: {ctor: '[]'}
															},
															{
																ctor: '::',
